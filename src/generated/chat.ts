...
export const ChatServiceService = {
  getListConversation: {
    ...
    requestSerialize: (value: GetListConversationRequest) =>
      Buffer.from(GetListConversationRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetListConversationRequest.decode(value),
    responseSerialize: (value: GetListConversationResponse) =>
      Buffer.from(GetListConversationResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetListConversationResponse.decode(value),
  },
  getConversation: {
