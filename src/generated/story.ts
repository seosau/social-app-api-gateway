...
export const StoryServiceService = {
  createStoryService: {
    ...
    requestSerialize: (value: CreateStoryRequest) => Buffer.from(CreateStoryRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CreateStoryRequest.decode(value),
    responseSerialize: (value: CreateStoryResponse) => Buffer.from(CreateStoryResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => CreateStoryResponse.decode(value),
  },
  getAllStoryService: {
    path: "/story.StoryService/GetAllStoryService",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetAllStoriesRequest) => Buffer.from(GetAllStoriesRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetAllStoriesRequest.decode(value),
    responseSerialize: (value: GetAllStoriesResponse) => Buffer.from(GetAllStoriesResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetAllStoriesResponse.decode(value),
  },
  getStoryService: {
  ...
  deleteStoryService: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: DeleteStoryRequest) => Buffer.from(DeleteStoryRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => DeleteStoryRequest.decode(value),
    responseSerialize: (value: DeleteStoryResponse) => Buffer.from(DeleteStoryResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => DeleteStoryResponse.decode(value),
  },
} as const;
