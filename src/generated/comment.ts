...
export const CommentServiceService = {
  getComments: {
    ...
    requestSerialize: (value: GetCommentsRequest) => Buffer.from(GetCommentsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetCommentsRequest.decode(value),
    responseSerialize: (value: GetCommentsResponse) => Buffer.from(GetCommentsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetCommentsResponse.decode(value),
  },
  createComment: {
    path: "/comment.CommentService/CreateComment",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateCommentRequest) => Buffer.from(CreateCommentRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CreateCommentRequest.decode(value),
    responseSerialize: (value: CreateCommentResponse) => Buffer.from(CreateCommentResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => CreateCommentResponse.decode(value),
  },
} as const;
